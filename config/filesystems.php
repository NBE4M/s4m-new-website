...
return [
    ...
    */
    ...
    'bucket' => env('GOOGLE_CLOUD_STORAGE_BUCKET', 'news-photo'),
    'path_prefix' => env('GOOGLE_CLOUD_STORAGE_PATH_PREFIX', null), // optional: /default/path/to/apply/in/bucket
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/news-photo/'), // see: Public URLs below
],
...
'album' => [
    ...
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/news-photo/album'),
],
...
'mastervideothumb' => [
    ...
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/news-photo/mastervideothumb'),
],
...
'rss' => [
    ...
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/news-photo/rss'),
],
'newsletter' => [
    'driver' => 'gcs',
    'project_id' => env('GOOGLE_CLOUD_PROJECT_ID', 'smiling-destiny-184908'),
    ...
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/news-photo/newsletter'),
],
