...
@section('title', 'Create New Album - E4MCMS')
...
<div class="main-content">
    ...
    <div class="container-fluid">  
        ...
        <div id="Text_Area_Resizable" class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <textarea  rows="4" class="" id="featuredesc" name="featuredesc">{{ old('featuredesc') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div id="Drag_And_Drop_Upload" class="control-group row-fluid">
            ...
            <div class="span9 row-fluid" >
                ...
                <input type="text" style="height: 0;visibility: hidden;width: 0;" id="uploadedImages" name="uploadedImages" value="{{ old('uploadedImages') }}">
            </div>
...
<script>
                                            $(document).ready(function () {
                                                $('#fileupload').fileupload({
                                                    ...
                                                    url: '<?php echo url('album/image/upload') ?>',
