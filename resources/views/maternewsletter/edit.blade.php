...
@section('title', 'Edit Newsletter- exchange4media')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                     <div class="alert alert-danger" id="testwait" style="display: none;">
                        ...
                        <a href="#" class="close" data-dismiss="alert">&times;</a>
                        <strong>Success!</strong> Test Mailer has been sent.
                        </div>
                      ...
                      <input type="hidden" readonly class="form-control" value="" name="posttype" id="posttype" />
                       <input type="hidden" readonly class="form-control url" value="" name="url" id="url" />
                        <input type="hidden" readonly class="form-control" value="" name="desc" id="desc" />
                         <input type="hidden" readonly class="form-control fromname" value="" name="fromname" id="fromname" />
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  ...
  if (fn=='1') {
   ...
   if (fn=='2') {
    $('#desc').val('Newsupdate test Newsletter has been sent');
  }
   if (fn=='3') {
...
<script type="text/javascript">
  ...
  if (fn=='1') {
   ...
   if (fn=='2') {
    $('#desc').val('Newsupdate Final Newsletter has been sent');
  }
   if (fn=='3') {
    $('#desc').val('Afternoon Post Final Newsletter has been sent');
  }
   if (fn=='4') {
...
<script type="text/javascript">
    $(window).load(function() {
        ...
        if (fn=='1') {
            ...
            $('.url').val(newurl);
            $('.fromname').val('exchange4media Morning Post');
        }
        if (fn=='2') {
            var newurl = '{{Config::get('constants.SiteBaseurl')}}newsletter/newsupdatenewsletter.html';
            $('a.urlbind').attr('href', newurl);
            $('.url').val(newurl);
            $('.fromname').val('exchange4media News Update ');
        }
        if (fn=='3') {
            var newurl = '{{Config::get('constants.SiteBaseurl')}}newsletter/afternoonnewsletter.html';
            $('a.urlbind').attr('href', newurl);
            $('.url').val(newurl);
           /* $('.fromname').val('exchange4media Afternoon Post');*/
            $('.fromname').val('exchange4media Afternoon Post ');
        ...
        if (fn=='4') {
            ...
            $('a.urlbind').attr('href', newurl);
            $('.url').val(newurl);
            $('.fromname').val('exchange4media Evening Post');
        }
        if (fn=='5') {
            var newurl = '{{Config::get('constants.SiteBaseurl')}}newsletter/breakingnewsletter.html';
            $('a.urlbind').attr('href', newurl);
            $('.url').val(newurl);
            $('.fromname').val('exchange4media Breaking News');
        }
    });
</script>
@stop
