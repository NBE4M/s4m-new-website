...
<h5 class="flama text-uppercase mb-0"><kbd><i class="fas fa-tags"></i> Privacy</kbd> Policy  </h5>            
                 </div> 
 
 <div class="row no-gutters">
                    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12 no-padding term">
    <h4 class="flama-font mb-1 mt-2">Privacy Policy</h4>
...
<h4 class="flama-font">1. INFORMATION RECEIVED, COLLECTED AND STORED BY THE COMPANY</h4>
<h5 class="flama-font">A. INFORMATION SUPPLIED BY USERS</h5>
...
<h5 class="flama-font">B. INFORMATION AUTOMATICALLY COLLECTED/ TRACKED WHILE NAVIGATION</h5>
...
<h4 class="flama-font">2. LINKS TO THIRD PARTY SITES / AD-SERVERS</h4>
...
<h4 class="flama-font">3. INFORMATION USE BY THE COMPANY</h4>
...
<h4 class="flama-font">4. INFORMATION SHARING</h4>
...
<h4 class="flama-font">5. ACCESSING AND UPDATING PERSONAL INFORMATION</h4>
...
<h4 class="flama-font">6. INFORMATION SECURITY</h4>
...
<h4 class="flama-font">7. UPDATES / CHANGES</h4>
...
<h4 class="flama-font">8. QUESTIONS / GRIEVANCE REDRESSAL</h4>
...
<p>Grievance Officer (Exchange4Media)<br>
