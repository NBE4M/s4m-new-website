                ...
                <a href="javascript:;" class="sub-nav-container">
                    ...
                    <div class="sub-nav">
                        <ul class="nav">
                           @if(in_array('59',Session::get('user_rights')))
                           <li>
                            <a href="{{url('liveDataall')}}">Upload New video</a>
                        </li>
                        <li>
                ...
                <a href="javascript:;" class="sub-nav-container">
                    ...
                    <div class="sub-nav">
                        <ul class="nav">
                            ...
                            @if(in_array('75',Session::get('user_rights')))
                            <li>
                                <a href="{{url('/menu/')}}">Menu Master</a>
                            </li>
                            @endif
                            @if(in_array('75',Session::get('user_rights')))
                            <li>
                                <a href="{{url('/banner/')}}">Banner Master</a>
                            </li>
                            @endif
                            @if(in_array('75',Session::get('user_rights')))
                            <li>
                    ...
                    <a href="javascript:;" class="sub-nav-container">
                        ...
                        <div class="sub-nav">
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="{{url('newsletter')}}">Create Newsletter</a>
                                </li>
                                @endif
         ...
         <!--     <li>
             ...
             <!-- <li>
                <a href="{{url('/create_event')}}" >
                    <i class="icon-photon document_alt_stroke"></i>
                    <span class="nav-selection">Create Events</span>
                                    </a>
                                </li> -->
