...
<div class="main-content">
    <div class="breadcrumb-container">
        ...
        <form method="post" action="{{url('category').'/'.$category->category_id}}" class="form-horizontal" id="fileupload">
   {{method_field('PUT')}}
   {{csrf_field()}}
        ...
        <div class="container-fluid">
            ...
            <div class="control-group row-fluid" id="Multiple_Select_Box_with_Filter_Search">
                ...
                <div class="control-group row-fluid">
                    <div class="span3">
                        <label for="add tags" class="control-label">Edit Category Name</label>
                    </div>
                    <div class="span9">
                        <div class="controls">
                            ...
                            <input type="text" name="category"id="category" value="{{$category->name}}" class="required"><span for="add tags" generated="true" class="error" style="display: none;">Please enter a valid text.</span>
                        </div>
                    </div>
                    <div class="span12 span-inset">
