    ...
    <form class="form-horizontal"method="POST" id='categoryform' action="{{url('')}}/category" onsubmit="return validateCategoryData();">
        ...
        <div class="container-fluid">
            ...
            <div class="control-group row-fluid" id="Multiple_Select_Box_with_Filter_Search">
                ...
                <div class="control-group row-fluid">
                    <div class="span3">
                        <label for="add tags" class="control-label">Add New Category Name</label>
                    </div>
                    <div class="span9">
                        <div class="controls">
                            <input type="hidden" name="parent_id" id="parent_id" value="{{$parentId}}"/>
                            <input type="text" name="category"id="category" class="required"><span for="add tags" generated="true" class="error" style="display: none;">Please enter a valid text.</span>
                        </div>
                    </div>
                    <div class="span12 span-inset">
