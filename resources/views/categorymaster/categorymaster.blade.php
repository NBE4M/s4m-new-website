...
<div class="main-content">
    <div class="breadcrumb-container">
        ...
        <h2><small><a href="{{url('')}}/category?channel={{$currentChannelId}}">Category Master</a></small></h2>
        <h2> <small> 
         @foreach($parents as $parent)
         >> <a href="{{url('')}}/category?id={{$parent->category_id}}">{{$parent->name}}</a>
            @endforeach
                        ...
                        $("#selectBoxFilter20").select2();
                           $("#selectBoxFilter20").change(function () {
                            $(this).find("option:selected").each(function () {
                                ...
                                window.location = '{{url("category")}}' + '?channel=' + $(this).attr("value").trim();
                            }
                    ...
                    <table class="table table-striped" id="tableSortable">
                        ...
                        <tbody>
                            ...
                            <tr id="rowCur{{$a->category_id}}">
                                ...
                                <td>{{$a->category_id}}</td>
                                <td><a href="{{url('')}}/category/{{$a->category_id}}">{{$a->name}}</a{></td>
                                <td>{{$a->userssname}}</td>
                                <td>{{$a->created_at}}</td>
                                <td>
