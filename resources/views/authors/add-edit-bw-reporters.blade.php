...
@section('title', 'Add-edit-guestauthor - E4MCMS')
                    ...
                    <table class="table table-striped table-responsive" id="tableSortableResMed">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX" id="rowCur{{$a->author_id}}">
                                <td style="width:160px;"><img src="{{ config('constants.awsbaseurl').config('constants.awalbumimagedir').$a->photo}}" alt="User Image" style="width:70%;" /></td>
