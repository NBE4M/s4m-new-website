...
@section('title', 'Add-edit-author - E4MCMS')
                    ...
                    <table class="table table-striped table-responsive" id="tableSortableResMed">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX" id="rowCur{{$a->author_id}}">
                                <td style="width:160px;"><img src="{{ config('constants.awsbaseurl').config('constants.ALBUM_IMAGE_DIR').$a->photo}}" alt="Author image" style="width:70%;" /></td>
