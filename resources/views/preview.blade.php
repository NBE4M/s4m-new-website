  ...
  <tr>
    <td width="100%" align="center" valign="top" bgcolor="#ffffff"><!-- One Column -->
      ...
      <table width="870"  class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff" style="margin:0 auto;">
        <tr>
          <td valign="top" style="padding:0; height:139px;" align="center" bgcolor="#ffffff"><img  class="deviceWidth" src="http://design.exchange4media.com/e4mdesigner/om/pr-mailer/header4.png" alt="thank you header" border="0" height="139" /></td>
        </tr>
          ...
          <table align="right" width="100%" cellpadding="0" cellspacing="0" border="0" class="deviceWidth" style="margin-bottom:15px;">
              ...
              <tr>
                <td style="mso-table-lspace:0;mso-table-rspace:0; margin:0; font-size:13px; line-height:20px;">
                  <p> Viewers witness the young woman ushered into the programme through a metaphorical royal welcome, where she is offered a crown, followed by a series of entitlements that she enjoys as part of her newfound status. They include, an exclusive dining experience, access to her favorite entertainment programme on an over-the-top media service provider and a free makeover session with a personal stylist. A vocal narration sums it up with three words, PERKS, PRIVILEGES and PRIDE, after a young man is seen receiving the invitation to be an insider. </p>
                    <br/>
