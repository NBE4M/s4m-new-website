...
<table width="550" border="0" cellpadding="0" cellspacing="0" align="center" style="border:dashed 2px #353458; border-radius:20px; display:block; padding:15px; margin-top:20px; margin-bottom:20px; margin-left:auto; margin-right:auto;">
  <tr>
    <td width="100%" align="center" valign="top" bgcolor="#ffffff"><!-- One Column -->
      ...
      <table width="550"  class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff" style="margin:0 auto;">
        <tr>
          <td valign="top" style="padding:0; height:163px;" align="center" bgcolor="#ffffff"><img  class="deviceWidth" src="{{url('img/thanks/header.png')}}" alt="" border="0" height="163" /></td>
        </tr>
        <tr>
          <td style="padding:10px;" bgcolor="#d7fbea">
              <p style="font-weight:bold; text-align:center; color:#45715c; font-size:16px; margin-bottom:5px;">Dear {{$name}}</p>
                <p style="font-size:14px; line-height:18px; font-weight:bold; text-align:center; color:#404040;"><span style="font-size:22px;">I</span>t is a great pleasure for us to share the details which covers from our exchange4media newsletter.</p>
            </td>
        </tr>
      ...
      <table width="550" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth" bgcolor="#ffffff" style="margin:0 auto;">
        <tr>
          <td>
          <table align="left" width="40%" cellpadding="0" cellspacing="0" border="0" class="deviceWidth" style="margin-bottom:15px;">
              <tr>
            ...
            <table align="right" width="58%" cellpadding="0" cellspacing="0" border="0" class="deviceWidth">
              <tr>
                  ...
                  <table width="100" align="right">
                    <tr>
                      <td bgcolor="#409ea8" style="padding:5px 0;background-color:#ffffff; border:1px solid #a7a7a7; background-repeat:repeat-x" align="center"><a href="{{$url}}"
                                                        ...
                                                        -webkit-text-size-adjust:none; color:#3F51B5;"> Read Story </a></td>
                    </tr>
                  </table>
                  </p></td>
              </tr>
      ...
      <td style="padding:10px 0">
            <table align="right" width="48%" cellpadding="0" cellspacing="0" border="0" class="deviceWidth" style="margin-bottom:15px;">
              <tr>
                <td valign="top" align="left" class="center"><p style="mso-table-lspace:0;mso-table-rspace:0; margin:0"><a href="#"><img width="267" src="https://storage.googleapis.com/news-photo/events-banner/event-banner-1.gif" alt="" border="0" style="border-radius: 4px; width: 267px; display: block;" class="deviceWidth" /></a></p></td>
              </tr>
            </table>
            <table align="left" width="48%" cellpadding="0" cellspacing="0" border="0" class="deviceWidth" style="margin-bottom:15px;">
              <tr>
                <td valign="top" align="right" class="center"><p style="mso-table-lspace:0;mso-table-rspace:0; margin:0"><a href="#"><img width="267" src="https://storage.googleapis.com/news-photo/events-banner/event-banner-2.gif" alt="" border="0" style="border-radius: 4px; width: 267px; display: block;" class="deviceWidth" /></a></p></td>
              </tr>
            </table>
            <table align="right" width="48%" cellpadding="0" cellspacing="0" border="0" class="deviceWidth">
              <tr>
                <td valign="top" align="left" class="center"><p style="mso-table-lspace:0;mso-table-rspace:0; margin:0"><a href="#"><img width="267" src="https://storage.googleapis.com/news-photo/events-banner/event-banner-3.gif" alt="" border="0" style="border-radius: 4px; width: 267px; display: block;" class="deviceWidth" /></a></p></td>
              </tr>
            </table>
            <table align="left" width="48%" cellpadding="0" cellspacing="0" border="0" class="deviceWidth">
              <tr>
                <td valign="top" align="right" class="center"><p style="mso-table-lspace:0;mso-table-rspace:0; margin:0"><a href="#"><img width="267" src="https://storage.googleapis.com/news-photo/events-banner/event-banner-4.gif" alt="" border="0" style="border-radius: 4px; width: 267px; display: block;" class="deviceWidth" /></a></p></td>
              </tr>
            </table>
      </td>
        </tr>
