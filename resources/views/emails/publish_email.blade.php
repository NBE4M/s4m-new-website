  ...
  <tr> 
         ...
         <td align="right" width="300" style="padding:10px;"><table border="0" cellspacing="0" cellpadding="0">
              <tbody><tr>
                ...
                <td align="right" valign="top" class="social" style=""><a href="#" target="_blank"> <img src="{{url('img/thanks/fb-icon-color.png')}}" height="24" width="24" alt="Facebook" border="0" style="display:block; max-width: 24px"> </a></td>
                <td width="5"></td>
                <td align="right" valign="top" class="social"><a href="#" target="_blank"> <img src="{{url('img/thanks/twitter-icon-color.png')}}" height="24" width="24" alt="Twitter" border="0" style="display:block; max-width: 24px"> </a></td>
                <td width="5"></td>
                <td align="right" valign="top" class="social"><a href="#" target="_blank"> <img src="{{url('img/thanks/linkedin-icon-color.png')}}" height="24" width="24" alt="Linkedin" border="0" style="display:block; max-width: 24px"> </a></td>
                <td width="5"></td>
