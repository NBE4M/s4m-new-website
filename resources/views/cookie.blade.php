...
<h5 class="flama text-uppercase mb-0"><kbd><i class="fas fa-tags"></i> Cookie </kbd>Policy   </h5>            
                 </div> 
 
 
<div class="col-md-12 col-xs-12 col-lg-12 col-sm-12 no-padding term">
    <h4 class="flama-font mb-1 mt-2">HOW DOES EXCHANGE4MEDIA USE COOKIES?</h4>
    
    <p>A cookie is a small piece of text that allows a website to recognize your device and maintain a consistent, cohesive experience throughout multiple sessions. If you use the Exchange4Media Platform, both Exchange4Media and third parties will use cookies to track and monitor some of your activities on and off the Exchange4Media Platform, and store and access some data about you, your browsing history, and your usage of the Exchange4Media Network.</p>
        <p>
This policy describes how both Exchange4Media and other third parties use cookies both within and without the Exchange4Media Platform and how you can exercise a greater degree of control over cookies. Please keep in mind that this may alter your experience with our platform, and may limit certain features (including being logged in as a user).</p>
...
<p><strong>Exchange4Media Main Website:</strong>&nbsp;We use cookies that support and enhance our public content platform by enabling important functionality. Such activity includes tracking and attributing content reads, push notifications and logins.
</p>
<p><strong>These cookies:</strong></p>
<ul>
...
<p>Allow us to track when a <strong>Exchange4Media</strong> user sees or clicks on an ad or later visits a third-party website or purchases a product on a third-party website</p>
...
<p>If you don’t want <strong>Exchange4Media</strong> to use cookies when you visit the <strong>Exchange4Media</strong> network of sites, you can opt-out of all cookies from your browser. If you opt-out of cookies, you might face issues w.r.t authentication on our platform and the functionality like bookmarks, read late, recommended content and your ability to write on <strong>Exchange4Media</strong> might not be as intuitive as it should be.</p>
...
<p>If you have any questions, comments, or concerns regarding this Cookies Policy, please contact <strong>Exchange4Media</strong> at:</p>
<p><a href="mailto:contact@exchange4media.com">contact@exchange4media.com</a></p>
