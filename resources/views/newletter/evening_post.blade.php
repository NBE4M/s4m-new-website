...
<title>Exchange4Media Evening Post</title>
<style type="text/css">
  ...
  <tr>
    ...
    <!--=======container table start=========-->
      <table width="600" cellpadding="0" class="full" cellspacing="0" border="0" align="center" style="width:600px;">
        <!--row start-->
        <tr>
          <td colspan="2"><img src="https://www.exchange4media.com/images/newsletter/eveningpost.png" width="600" alt="Logo" border="0" style="max-width: 100%; display:block; ">
		  <!-- <img src="https://www.exchange4media.com/images/newsletter/GoaFestBanner5april18.jpg" width="600" alt="Logo" border="0" style="max-width: 100%; display:block; "> --></td>
        </tr>
        <!--row end--> 
        <!--  <tr>
     ...
     <!--    <tr>
       ...
       <!--  <tr>
        ...
        @foreach($ArrViewArticle->take(5) as $key =>  $ArrlistingArticle)
        <tr>
...
<a href="@if ($ArrlistingArticle->url !=''){{$ArrlistingArticle->url}}@else {{Config::get('constants.SiteBaseurl')}}{!! Helper::rscUrl($ArrlistingArticle->name)!!}/{!! Helper::rscUrl($ArrlistingArticle->title) !!}_{{ $ArrlistingArticle->article_id }}.html @endif" target="_blank"><img src="{{Config::get('constants.awsbaseurl')}}{{ $ArrlistingArticle->photopath }}" width="280" style="display: block; border: 0px; width:280px;
 max-width:100%;" class="full" /></a></td>
                </tr>
              </tbody>
            </table>
...
<a href="{{$ArrlistingArticle->url}}" target="_blank"
 style="color:#000000; text-decoration:none; color:#000000; font-size:16px;
  line-height: 20px; font-weight:bold;"> {{Str::limit($ArrlistingArticle->title , $limit = 90, $end = '...')}}</a>
...
<td width="5"></td>
        ...
        @endforeach
          ...
          <tr>
            <td bgcolor="#ffffff" colspan="2" style="padding:10px;"><p style="padding:10px; border:1px solid #cccccc; color:#5a5a5a; line-height:22px; margin:0;"> If you're having trouble viewing this email, please <a href="{{Config::get('constants.SiteCmsurl')}}newsletter/evening-post-<?php echo date('d-m-Y')?>.html" style="color:#0066b4;">click 
              here</a></p></td>
            </tr>
        <tr> 
          <!-- SOCIAL -->
