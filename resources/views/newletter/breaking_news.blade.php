...
<title>Exchange4Media Breaking News</title>
<style type="text/css">
  ...
  <tr>
    ...
    <!--=======container table start=========-->
      <table width="600" cellpadding="0" class="full" cellspacing="0" border="0" align="center" style="width:600px;">
        <!--row start-->
        <tr>
          <td colspan="2"><img src="https://www.exchange4media.com/images/newsletter/breakingnewsbanner.png" width="600" alt="Logo" border="0" style="max-width: 100%; display:block; "></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" class="card-1" width="100%" valign="top" align="center">
                      <table style="border-radius: 3px;" width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="full" bgcolor="#ffffff">
                        <tr>
                          <td align="center" style="padding:10px;">
                            <table cellpadding="0" cellspacing="0" width="500" border="0" class="full">
                              <!-- START HEADER IMAGE -->
                              <tr>

                                <td align="center" class="hund ripplelink">
                                   <a href="{{$ArrlistingArticle->url}}" target="_blank" style="color:#000000; text-decoration:none; color:#000000; font-size: 16px; line-height: 20px; font-weight:bold;">
                                  <img align="center" width="580" style="width: 100%;" class="hund" src="{{Config::get('constants.awsbaseurl')}}{{ $ArrlistingArticle->photopath }}"></a>
                                </td>
                              </tr>
                              
                              
                              <tr>
<td bgcolor="#ffffff" align="left" valign="top" class="story pdt10" colspan="2"
 style="padding-top:15px;">
<a href="{{$ArrlistingArticle->url}}" target="_blank" 
  style="color:#000000; text-decoration:none; 
  color:#000000; font-size: 16px; line-height: 
  20px; font-weight:bold;">
  {{Str::limit($ArrlistingArticle->title , $limit = 90, $end = '...')}}</a>
<p class="description" 
...
line-height:18px;
 margin:5px 0px;
  color:#585858;">
  {{Str::limit($ArrlistingArticle->summary , $limit = 130, $end = '...')}}
</p>
</td>
                                        </tr>
                                        <!-- END BODY COPY -->
                                        <!-- BUTTON -->
                                        <tr>
                                          <td bgcolor="#ffffff" align="left" style="padding:5px 0;">
       ...
       <!--blank row start-->
        ...
        <!--blank row end-->
         ...
         <!--  <td bgcolor="#ffffff" colspan="2" style="padding:10px;"><p style="padding:10px; border:1px solid #cccccc; color:#5a5a5a; line-height:22px; margin:0;"> If you're having trouble viewing this email, please <a href="http://cms.exchange4media.com/newsletterhtml/NewsLetter14032018.html" style="color:#0066b4;">click 
          ...
          <tr>
            <td bgcolor="#ffffff" colspan="2" style="padding:10px;"><p style="padding:10px; border:1px solid #cccccc; color:#5a5a5a; line-height:22px; margin:0;"> If you're having trouble viewing this email, please <a href="{{Config::get('constants.SiteCmsurl')}}newsletter/breaking-post-<?php echo date('d-m-Y')?>.html" style="color:#0066b4;">click 
              here</a></p></td>
            </tr>
        <tr> 
          <!-- SOCIAL -->
