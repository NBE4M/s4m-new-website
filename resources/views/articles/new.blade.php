...
@section('title', 'New Articles - E4MCMS')
...
<!--                            <tr class="gradeX">
                            ...
                            <tr class="gradeC" id="rowCur{{$article->article_id}}">
                               ...
                               <td>@if($article->locked_by == Session::get('users')->id || Session::get('users')->user_type_id == 1 || Session::get('users')->user_type_id == 28)<a href="{{ url('') }}/article/{{ $article->article_id }}"  >{{$article->title}}</a>@elseif($article->locked_by==null)<a href="{{ url('') }}/article/{{ $article->article_id }}"  >{{$article->title}}</a>@else<a href="#" class="dabled" >{{$article->title}}</a>@endif
                                    </td>
                                <td>{{$article->username}}</td>
                                <td>{{$article->name}}</td>
                                <td><a target="_blank" href="/{{ $article->article_id }}.html"><button type="button" class="btn btn-warning">Preview</button></a></td>
