...
@section('title', 'Deleted Articles - E4MCMS')
...
<!--                            <tr class="gradeX">
                            ...
                            <tr class="gradeX" id="rowCur{{$article->article_id}}">
                                <td><a href="{{url('')}}/article/{{ $article->article_id }}">{{ $article->article_id }}</a> <a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="Assigned to -{{ $article->name }}, Assigned by -"  style="display:block;"><i class="icon-photon info-circle"></i></a>
                                </td>
