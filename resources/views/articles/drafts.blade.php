...
@section('title', 'My Drafts - E4MCMS')
                    ...
                    <table class="table table-striped" id="tableSortable">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeA" id="rowCur{{$article->article_id}}" >
                                <td><a href="{{url('')}}/article/{{ $article->article_id }}">{{ $article->article_id }}</a> <a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="Assigned to -Sharabani Mukherjee, Assigned by -Hiten Mehta"  style="display:block;"><i class="icon-photon info-circle"></i></a>
                                </td>
