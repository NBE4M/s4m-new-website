...
@section('title', 'Edit Article - E4MCMS')
@section('content')
                            ...
                            <script>
                                   ...
                                   $().ready(function() {
                                        $("#author").tokenInput(function(){
                                              return "{{url('')}}/article/authordd?option="+$("#simpleSelectAuthor").val(); 
                                        },
                                            {
                                                theme: "facebook",
                                                searchDelay: 300,
                                ...
                                <table class="table table-striped table-responsive uploaded-image-list" id="tableSortableResMed">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="row_{{$photo->photo_id}}" title="{{$photo->photopath}}">
                                            <td>
                                                <img width="150px" src="{{ config('constants.awsbaseurl').$photo->photopath}}" alt="article" />
                                            </td>
...
//                    });
    ...
    @endif
    <div class="container-fluid">
        <div class="form-legend" id="Agency-Details">Agency Details
        </div>
        <!--Text Area - No Resize begin-->
        <div  class="control-group row-fluid">
            <div class="span2">
                <label class="control-label" for="title">PR-Name</label>
            </div>
            <div class="span4">
                <div class="controls">
                   <input type="text" class="valid" name="pname" value="{{$article->pr_name}}" id="pname"/>
                </div>
            </div>
        </div>
        <div  class="control-group row-fluid">
            <div class="span2">
                <label class="control-label" for="title">PR-Email</label>
            </div>
            <div class="span4">
                <div class="controls">
                   <input type="text" class="valid" name="pemail" value="{{$article->pr_email}}" id="pemail"/>
                </div>
            </div>
        </div>
        <div  class="control-group row-fluid">
            <div class="span2">
                <label class="control-label" for="title">PR-Mobile</label>
            </div>
            <div class="span4">
                <div class="controls">
                   <input type="text" class="valid" name="pmobile" value="{{$article->pr_number}}" id="pmobile"/>
                </div>
            </div>
        </div>
 ...
 <label class="checkbox" >
                ...
                <label class="checkbox" >
                    <input type="radio" name="important" class="uniformCheckbox" value="f" @if($article->web_exclusive == 1) checked @endif>
