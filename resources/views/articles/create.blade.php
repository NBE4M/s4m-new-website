...
<div class="main-content retracted">
    ...
    <div class="container-fluid">
        ...
        <div id="Simple_Select_Box" class="control-group row-fluid">
            ...
            <div class="span10">
                {!! Form::select('authortype',['' => 'Please Select'] + $p1->toArray(),null,
                            ...
                            <script>
                                       ...
                                       $().ready(function() {
                                        $("#author").tokenInput(function(){
                                           return "{{url('')}}/article/authordd?option=" + $("#authortype").val();
                                        },
                                        {
                                        theme: "facebook",
                                                searchDelay: 300,
    ...
    <div class="container-fluid">
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span10">
                <div class="controls">
                    <textarea  name="title" rows="2" class="no-resize  title_range valid" id="artititle"></textarea>
        ...
        <div id="Text_Area_Resizable" class="control-group row-fluid">
            ...
            <div class="span10">
                <div class="controls">
                    <textarea  name="summary" rows="4" class="" id="summary"></textarea>
                </div>
            </div>
        </div>
...
//                                         //$("#Taglist").tokenInput("add", {id: 9992, name: "test22"});
                                ...
                                $("#Taglist").tokenInput("{{url('')}}/tags/getJson", {
                        theme: "facebook",
                                searchDelay: 300,
                                minChars: 4,
                                preventDuplicates: true,
...
<!--        <input type="hidden" id="uploadedVideos" name="uploadedVideos[]">-->
   ...
   <div class="container-fluid">
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span10">
                <div class="controls">
                   <input type="text" class="valid" name="pname" id="pname"/>
                </div>
            </div>
        </div>
        <div  class="control-group row-fluid">
            ...
            <div class="span10">
                <div class="controls">
                   <input type="text" class="valid" name="pemail" id="pemail"/>
                </div>
            </div>
        </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span10">
                <div class="controls">
                   <input type="text" class="valid" name="pmobile" id="pmobile"/>
                </div>
            </div>
        </div>
...
<!-- 
                ...
                <label class="checkbox" >
                    <input type="radio" name="important" class="uniformCheckbox" value="f">
