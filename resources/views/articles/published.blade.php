...
@section('title', 'Published Articles - E4MCMS')
                            ...
                            <tr class="gradeX"  id="rowCur{{$article->article_id}}">
                                <td>{{$article->article_id}}
                                    @foreach($editor as $ed)
                                        ...
                                        @endif
                                    @endforeach</td>
                                <td>@if($article->locked_by == '' || $article->locked_by == Session::get('users')->id || Session::get('users')->user_type_id == 1 || Session::get('users')->user_type_id == 2)<a href="{{url('')}}/article/{{ $article->article_id }}">{{ $article->title }}</a>@elseif($article->locked_by !== '')<a href="#" class="dabled" >{{$article->title}}</a>@endif
                                </td>
            ...
            <script>
                ...
                function deleteArticle() {
                    ...
                    if (checkedVals.length > 0) {
                        ...
                        //alert("{{ url('/article/delete/?channel=').$currentChannelId}}");return false;
