...
@section('title', 'Create New Video - E4MCMS')
...
<div class="main-content">
    ...
    <div class="container-fluid">
        ...
        <div id="tab-example1" class="tab-pane fade active in">
            ...
            <div class="control-group row-fluid">
                <div class="span3">
                    <label class="control-label">Video Source(Origin)</label>
                </div>
                <div class="span9">
                    <div class="controls">
                        <input name="video_source" id="video_source" type="text">
                    </div>
                </div>
            </div>
            <div class="control-group row-fluid">
                <div class="span3">
                    <label class="control-label">Advertiser/Brand</label>
                </div>
                <div class="span9">
                    <div class="controls">
                        <input name="advertiser" id="advertiser" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="controls">
                        <input name="agency" id="agency" type="text">
                    </div>
                </div>
            </div>
            ...
            <div  class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="controls">
                        <textarea  rows="4" class="" name="embed_code" id="embed_code"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div  class="control-group row-fluid">
                <div class="span3">
                    <label class="control-label" for="selectBoxFilter">Video Type</label>
                </div>
                <div class="span9">
                    <div class="controls">
                        <select name="video_type" id="video_type">
                            <option value="2"> Creative Showcase</option>
                        </select>
                    </div>
                </div>
                <script>
