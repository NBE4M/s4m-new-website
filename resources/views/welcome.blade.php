  ...
  <div class="row m-lg-0">
    <div class="breaking_news">
      ...
      <div class="news_title">
        <strong>
          <a href="#">
            चौथी दुनिया का बड़ा खुलासा: दैनिक भास्कर के पूर्व ग्रुप एडिटर कल्पेश याग्निक की ‘हत्या’!
          </a>
        </strong>
      </div>
    </div>  
       ...
       <div class="carousel-inner">
        ...
        <div class="carousel-item active">        
          <div class="card bg-dark text-white">
            <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$keyhomeslide->photopath}}" alt="{{$keyhomeslide->phototitle}}" onerror="this.onerror=null;this.src='images/top-story1.jpg';">
            <div class="card-img-overlay d-flex linkfeat">
              <a href="{{$keyhomeslide->url}}" class="align-self-end">
                <span class="badge">{{$keyhomeslide->category_hname}}</span> 
        ...
        <div class="carousel-item">       
          <div class="card bg-dark text-white">
            <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$keyhomeslide->photopath}}" alt="{{$keyhomeslide->phototitle}}" onerror="this.onerror=null;this.src='images/top-story2.jpg';">
            <div class="card-img-overlay d-flex linkfeat">
              <a href="{{$keyhomeslide->url}}" class="align-self-end">
                <span class="badge">{{$keyhomeslide->category_hname}}</span> 
                <h4 class="card-title">{{$keyhomeslide->title}}</h4>
        ...
        <div class="carousel-item">       
          <div class="card bg-dark text-white">
            <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$keyhomeslide->photopath}}" alt="{{$keyhomeslide->phototitle}}" onerror="this.onerror=null;this.src='images/top-story3.jpg';">
            <div class="card-img-overlay d-flex linkfeat">
              <a href="{{$keyhomeslide->url}}" class="align-self-end">
                <span class="badge">{{$keyhomeslide->category_hname}}</span> 
                <h4 class="card-title">{{$keyhomeslide->title}}</h4>
        ...
        <div class="carousel-item">       
          <div class="card bg-dark text-white">
            <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$keyhomeslide->photopath}}" alt="{{$keyhomeslide->phototitle}}" onerror="this.onerror=null;this.src='images/top-story4.jpg';">
            <div class="card-img-overlay d-flex linkfeat">
              <a href="{{$keyhomeslide->url}}" class="align-self-end">
                <span class="badge">{{$keyhomeslide->category_hname}}</span> 
                <h4 class="card-title">{{$keyhomeslide->title}}</h4>                    
        ...
        @elseif ($rows_articlehomeslide=='5')
        @php  $rows_articlehomeslide++; @endphp
        <div class="carousel-item">       
          <div class="card bg-dark text-white">
            <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$keyhomeslide->photopath}}" alt="{{$keyhomeslide->phototitle}}" onerror="this.onerror=null;this.src='images/top-story4.jpg';">
  ...
  <div class="col-md-3 mob-mb-15">
    <div class="row">
      <div class="col-6 col-sm-12 col-md-12 col-lg-6 pr-0">
        <a href="story.html">
          <img class="img-fluid img-thumbnail" src="{{Config::get('constants.storagepath')}}/{{$iB->photopath}}" alt="{{$iB->phototitle}}" onerror="this.onerror=null;this.src='images/industry-story1.jpg';">
        </a>
      </div>
  ...
  <div class="col-lg-6 col-md-12 pl-4 pr-4 dashed-bdr-r mob-p-0 mob-bdr-0">
    <div class="row mob-m-0">
      ...
      <div class="col-md-6 p-1 mob-p-0 admsn-top-stry"> 
        <a href="{{ $jobs[$x]->url }}">
          <img class="img-fluid img-thumbnail border-0" src="{{Config::get('constants.storagepath')}}/{{$jobs[$x]->photopath}}" alt="{{$jobs[$x]->phototitle}}" onerror="this.onerror=null;this.src='images/new-1.jpg';">
        </a>
      ...
      <div class="col-md-6 media-form mob-admsn-reltd">
        ...
        <div class="row mt-1">
          <div class="col-6 col-sm-12 col-md-5 col-lg-5 pr-0">
            <a href="{{ $jobs[$x]->url }}">
              <img class="img-fluid img-thumbnail border-0" src="{{Config::get('constants.storagepath')}}/{{$jobs[$x]->photopath}}" alt="{{$jobs[$x]->phototitle}}" onerror="this.onerror=null;this.src='images/admision-story2.jpg';">
            </a>
          </div>
...
<div class="row mt-3">
  ...
  <div class="col-lg-4 col-md-12 media-form dashed-bdr-r mob-p-0 mob-bdr-0"> 
    <a href="{{$mR->url}}">
      <img class="img-fluid img-thumbnail border-0" src="{{Config::get('constants.storagepath')}}/{{$mR->photopath}}" alt="{{$mR->phototitle}}" onerror="this.onerror=null;this.src='images/lok-news.jpg';">
    </a>
...
<div class="row">
    ...
    <div class="row mob-bg-light-y">
      <div class="col-lg-6 col-md-12 col-sm-12 pb-2 mg-1 mob-bdr-0 tab-brd-b pb-md-3">
        <div class="card bg-dark text-white mob-bdr-solid mob-radius-0 mob-mt-15">
          <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$interview[$i]->photopath}}" alt="{{$interview[$i]->phototitle}}" onerror="this.onerror=null;this.src='images/brand-1.jpg';">
          <div class="card-img-overlay d-flex">
            <a href="{{$interview[$i]->url}}" class="align-self-end">
              <span class="badge">{{$interview[$i]->category_hname}}</span> 
      ...
      <div class="col-lg-6 col-md-12 col-sm-12 pb-2 mg-1 pt-md-1">
        <div class="card bg-dark text-white mob-bdr-solid mob-radius-0 mob-mt-8 mob-mb-8">
          <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$interview[$i]->photopath}}" alt="{{$interview[$i]->phototitle}}" onerror="this.onerror=null;this.src='images/brand-2.jpg';">
          <div class="card-img-overlay d-flex">
            <a href="{{$interview[$i]->url}}" class="align-self-end">
              <span class="badge">{{$interview[$i]->category_hname}}</span> 
              <h6 class="card-title mb-0">{{$interview[$i]->title}}</h6>
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 m-auto">
    ...
    <div class="row mob-bg-light-y">      
      <div class="col-lg-6 col-md-12 col-sm-12 pb-2 mg-1 mob-bdr-0 tab-brd-b pb-md-3">
        <div class="card bg-dark text-white mob-bdr-solid mob-radius-0 mob-mt-15">
          <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$vicharmanch[$y]->photopath}}" alt="{{$vicharmanch[$y]->phototitle}}" onerror="this.onerror=null;this.src='images/new-1.jpg';">
          <div class="card-img-overlay d-flex">
            <a href="{{$vicharmanch[$y]->title}}" class="align-self-end">
              <span class="badge">{{$vicharmanch[$y]->category_hname}}</span> 
      ...
      <div class="col-lg-6 col-md-12 col-sm-12 pb-2 mg-1 pt-md-1">
        <div class="card bg-dark text-white mob-bdr-solid mob-radius-0 mob-mt-8 mob-mb-8">
          <img class="card-img img-fluid" src="{{Config::get('constants.storagepath')}}/{{$vicharmanch[$y]->photopath}}" alt="{{$vicharmanch[$y]->phototitle}}" onerror="this.onerror=null;this.src='images/new-2.jpg';">
          <div class="card-img-overlay d-flex">
            <a href="{{$vicharmanch[$y]->title}}" class="align-self-end">
              <span class="badge">{{$vicharmanch[$y]->category_hname}}</span> 
              <h6 class="card-title mb-0">{{$vicharmanch[$y]->title}}</h6>
  ...
  <div class="row section_6">
    ...
    <div class="col-lg-4 col-md-6 pl-5 mob-p-0 p-md-3 red-r-bdr">
      ...
      <a href="{{$brandSpeaks[$z]->url}}">
        <img class="img-fluid img-thumbnail" src="{{Config::get('constants.storagepath')}}/{{$brandSpeaks[$z]->photopath}}" alt="{{$brandSpeaks[$z]->phototitle}}" onerror="this.onerror=null;this.src='images/interview-1.jpg';">
      </a>
    ...
    <div class="col-lg-4 col-md-6 pr-5 mob-mt-30 mob-p-0 p-md-3">
      ...
      <a href="{{$Adv[$p]->url}}">
        <img class="img-fluid img-thumbnail" src="{{Config::get('constants.storagepath')}}/{{$Adv[$p]->photopath}}" alt="{{$Adv[$p]->phototitle}}" onerror="this.onerror=null;this.src='images/interview-2.jpg';">
      </a>
      <h6 class="mt-2 mb-1 font-heading-1">
        <strong>
    ...
    <div class="col-lg-6 col-md-12 m-md-auto pl-0 dashed-bdr-r mob-p-0 mob-bdr-0 tab-bdr">
      ...
      <div class="row ml-0 mb-2 title-holder mob-p-10">
        <div class="widget-title-cover yellow-hed">
          ...
          <a href="{{url('photos.html')}}" title="और देखें" class="float-right mt-1 pl-2 text-danger mob-seemore bg-white">
            <strong>और पढ़ें</strong>
          </a>
        </div>
      </div>
        ...
        <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails mb-0" data-ride="carousel">
          ...
          <div class="carousel-inner full-gallery-img" role="listbox">
            ...
            <div class="carousel-item active"> 
              <a href="#">
                <img class="d-block w-100" src="{{Config::get('constants.storagepath')}}/{{$frontalbum[$al]->photopath}}" alt="{{$frontalbum[$al]->phototitle}}" onerror="this.onerror=null;this.src='{{url("images/brand-1.jpg")}}';">                
              </a>
            </div>
            @endfor
            @for($al=1;$al < 10;$al++)
        ...
        <ol class="carousel-indicators image-gallery scrollbar style-4">
          ...
          <li data-target="#carousel-thumb" data-slide-to="0" class="active"> 
            <img class="d-block w-100 img-thumbnail" src="{{Config::get('constants.storagepath')}}/{{$frontalbum[$al]->photopath}}" alt="{{$frontalbum[$al]->phototitle}}" onerror="this.onerror=null;this.src='{{url("images/brand-1.jpg")}}';">
          </li>
          @endfor
          @for($al=1;$al > 10;$al++)
      ...
      <div class="col-lg-6 col-md-12 m-md-auto">
        ...
        <div class="row ml-0 mb-2 title-holder mob-mt-30 mob-mb-15  mt-md-4">
          <div class="widget-title-cover heading-3">
            ...
            <a href="videos.html" title="और देखें" class="float-right mt-1 pl-2 text-danger mob-seemore bg-white">
              <strong>और पढ़ें</strong>
            </a>
          </div>
        </div>
          <div class="row">
            ...
            <div class="col-lg-9 col-md-12 video-selected mob-p-0">
              <div class="video-iframe">
                <iframe src="https://www.youtube.com/embed/{{$videos[$vc]->vid}}" frameborder="0" allowfullscreen></iframe>
              </div>
            </div>
            @endfor
            <div class="col-lg-3 col-md-12 m-md-auto video-thumbnails video-gallery scrollbar style-4">
              ...
              <div class="video-thumb">
                ...
                <iframe class="iframe" src="https://www.youtube.com/embed/{{$videos[$vc]->vid}}" frameborder="0" allowfullscreen></iframe>
              </div>
              @endforeach
            </div>
          </div>
