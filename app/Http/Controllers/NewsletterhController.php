...
$fh3 = $_SERVER['DOCUMENT_ROOT'] . "/newsletterhtml/evening-post-".$fname.".html";
$fh4 = $_SERVER['DOCUMENT_ROOT'] . "/newsletterhtml/breaking-post-".$fname.".html";
$ch = curl_init();
...
$url3 = file_get_contents(Config::get('constants.SiteBaseurl').'newsletter/eveningnewsletter.html');
$url4 = file_get_contents(Config::get('constants.SiteBaseurl').'newsletter/breakingnewsletter.html');
