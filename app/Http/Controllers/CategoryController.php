...
class CategoryController extends Controller
{
    ...
    public function index()
    {
       ...
       if(isset($_GET['keyword'])){
        ...
        return view('categorymaster.categorymaster',compact('categories','channels','currentChannelId','parentId','parents'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $category->channel_id=$currentChannelId;
        $category->category_url=strtolower(preg_replace('/([^a-zA-Z0-9_.])+/', '-',$request->category));
